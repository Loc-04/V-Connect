...
const menuMain: ProfileMenuItem[] = [
  { label: 'Dashboard', icon: LayoutDashboard, to: '/volunteer/home' },
  { label: 'Browse', icon: Activity, to: '/browse' },
  { label: 'My Profile', icon: Sparkles, to: '/volunteer/profile-ui' },
];

const menuRecords: ProfileMenuItem[] = [
  { label: 'Participation History', icon: History, to: '/volunteer/participation-history' },
  { label: 'Certificates', icon: Award, to: '/volunteer/profile-ui#certificates' },
];
              ...
              <div className="vol-profile-grid-two">
                <article className="vol-profile-card">
                  <div className="vol-profile-card-head">
                    ...
                    <button type="button" aria-label="Add skill" onClick={() => setEditing(true)}>
                      <Plus size={16} />
                    </button>
                  </div>
