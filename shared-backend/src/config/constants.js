...
const activityColumns =
  'id, title, description, cover_image_url, location, start_time, end_time, capacity, required_skills, status, organizer_id, province_code, ward_code, created_at, updated_at, deleted_at';
